  ...
  return _c(
    ...
    [
      _c("v-toolbar-title", {
        ...
        domProps: {
          textContent: _vm._s(
            _vm.$route.params.user_id > 0 ? "Файлы " : "Мои файлы"
          )
        }
      }),
      _vm._v(" "),
