...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    showItem: function showItem(id) {
      console.log(id);
      var l = Number.parseInt(this.$route.query.level);
      this.$router.push({
        name: 'districts',
        params: {
