...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    "delete": function _delete() {
      ...
      if (this.delete_id > 0) window.axios["delete"]('/file/' + this.delete_id).then(function (response) {
        _this2.getPage();
