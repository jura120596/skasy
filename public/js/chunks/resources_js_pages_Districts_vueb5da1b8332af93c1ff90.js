    ...
    return {
      ...
      headers: {
        regions: [{
          value: 'name',
          text: 'Район',
          link: Number.parseInt(_this.$route.query.level) < 2,
          id: 'id'
        }]
      },
      filter: {
