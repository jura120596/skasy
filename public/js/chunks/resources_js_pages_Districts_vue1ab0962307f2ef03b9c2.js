    ...
    return {
      ...
      headers: {
        regions: [{
          value: 'name',
          text: 'Район',
          link: Number.parseInt(мь.$route.query.level) < 2,
          id: 'id'
        }]
      },
      filter: {
