  ...
  mounted: function mounted() {
    ...
    if (modelId != 0) {
      window.axios.get('/auth/post/' + modelId).then(function (response) {
        ...
        _this2.$root.$children[0].snackbarText = (e === null || e === void 0 ? void 0 : e.response.error) || 'Произошла ошибка';
