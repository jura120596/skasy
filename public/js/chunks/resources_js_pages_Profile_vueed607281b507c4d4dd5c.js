...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeMount: function beforeMount() {
    ...
    this.$store.dispatch('auth/attempt').then(function () {
      _this.user = _objectSpread(_objectSpread({}, _this.$store.state.auth.user), {}, {
        password: '',
        password_confirmation: ''
      });
    });
