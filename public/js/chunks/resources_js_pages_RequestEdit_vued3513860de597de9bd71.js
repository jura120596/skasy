...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    create: function create() {
      ...
      if (!(this.request.id > 0)) window.axios.post('/request', this.request).then(function (r) {
        _this.$router.push({
          name: "request",
          params: {
            id: r.data.data.id
