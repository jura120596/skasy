  ...
  return _c(
    ...
    [
      ...
      _vm.$store.state.auth.user.role === 1024
        ...
        : _vm._e(),
      _vm._v(" "),
      !!_vm.dialogPost && _vm.delete_id == 0
        ? _c(
            "v-dialog",
            {
