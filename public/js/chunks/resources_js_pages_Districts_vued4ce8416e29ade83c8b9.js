  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        {
          staticClass: "ml-4",
          attrs: { to: "/regions/" + _vm.$route.params.id + "/0" }
        },
        [_vm._v("Добавить +")]
      ),
      _vm._v(" "),
