    ...
    getPlaces: function getPlaces() {
      ...
      window.axios.get('/mapObject/', {
        ...
        _this2.places.filter(function (v) {
          ...
          var markerHtmlStyles = "background-color: ".concat(myCustomColour, "; width: 3rem;height: 3rem;display: block;\n                      left: -1.5rem;top: -1.5rem;position: relative;border-radius: 3rem 3rem 0;transform: rotate(45deg);border: 1px solid #FFFFFF");
