...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mounted: function mounted() {
    ...
    if (modelId !== '0') {
      ...
      console.log(this.$store.state.auth.user.district_id);
      this.user = {
        admin: false,
        librarian: true,
        district_id: this.$store.state.auth.user.district_id
      };
    }
  },
  methods: {
