  ...
  methods: {
    ...
    addPhoto: function addPhoto(event) {
      ...
      if (this.fileImg.size < 5024000) {
        ...
        t.$root.$children[0].snackbarText = '';
      }
    }
  }
});
