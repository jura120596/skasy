  ...
  methods: {
    showItem: function showItem(id) {
      this.$router.push({
        ...
        query: {
          level: this.$route.query.level ? this.$route.query.level + 1 : this.$route.query.level
        }
      });
    }
  }
