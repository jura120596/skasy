  ...
  methods: {
    showItem: function showItem(id) {
      this.$router.push({
        ...
        params: {
          region: this.$router.params.region,
          code: id
        }
      });
    }
