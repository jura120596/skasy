    ...
    signUp: function signUp() {
      ...
      window.axios.post('/auth/signup', this.account).then(function (r) {})["catch"](function (e) {
        if (e.response && e.response.status === 422) {
          Object.getKeys(_this.messages).forEach(function (k) {
