...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    editItem: function editItem(id, item, value) {
      ...
      if (value == 'full_name') $router.push('/user/' + user.id);
    },
