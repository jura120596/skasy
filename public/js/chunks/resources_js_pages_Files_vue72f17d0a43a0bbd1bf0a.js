...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    download: function download(url) {
      window.axios.get(window.location.origin + url, {
        method: 'GET',
        responseType: 'blob'
