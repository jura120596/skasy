...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data(vm) {
    console.log(vm.$route.query.role);
    return {
      request: {
