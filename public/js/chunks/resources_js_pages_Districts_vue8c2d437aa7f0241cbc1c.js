...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    districtsItemsUrl: function districtsItemsUrl() {
      return '/district?level=' + this.level + '&parent_district_id=' + $route.params.id;
    },
