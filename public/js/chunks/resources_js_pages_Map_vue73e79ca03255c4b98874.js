...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n#mapid[data-v-405bff63] {\n    min-height: 200px;\n    height: 95vh;\n}\n", "",{"version":3,"sources":["webpack://./resources/js/pages/Map.vue"],"names":[],"mappings":";AA2BA;IACA,iBAAA;IACA,YAAA;AACA","sourcesContent":["<template>\n    <v-container class=\"ma-0 pa-0\">\n        <div id=\"mapid\"></div>\n    </v-container>\n</template>\n\n<script>\n    export default {\n        name: \"Map\",\n        mounted() {\n            var mymap = L.map('mapid').setView([55.536446, 47.498600], 13);\n            L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoianVyYTk2IiwiYSI6ImNrcGw1MWVzODFkazQyd284bjY0ZWIxbmIifQ.CWG9L2rMStLO3i3AOgrnyQ', {\n                attribution: 'Map data &copy; <a href=\"https://www.openstreetmap.org/copyright\">OpenStreetMap</a> contributors, Imagery © <a href=\"https://www.mapbox.com/\">Mapbox</a>',\n                maxZoom: 18,\n                id: 'mapbox/streets-v11',\n                tileSize: 512,\n                zoomOffset: -1,\n                accessToken: 'your.mapbox.access.token'\n            }).addTo(mymap);\n        },\n        methods: {\n\n        }\n    }\n</script>\n\n<style scoped>\n    #mapid {\n        min-height: 200px;\n        height: 95vh;\n    }\n</style>"],"sourceRoot":""}]);
// Exports
