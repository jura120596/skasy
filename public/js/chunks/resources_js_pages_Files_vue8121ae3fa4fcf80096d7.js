  ...
  methods: {
    ...
    upload: function upload() {
      ...
      if (newPhotos.length) {
        ...
        try {
          window.axios.post('/file/', formData);
        } catch (e) {
          console.log(e);
