...
var render = function() {
  ...
  return _c(
    "v-card",
    {
      ...
      attrs: { "justify-center": "", "allign-center": "" }
    },
    [
      _c("input", {
      ...
      _vm.$route.params.id > 0
        ? _c(
            ...
            [
              _c(
                "v-btn",
                { staticClass: "btn ma-auto", on: { click: _vm.clickOnInput } },
