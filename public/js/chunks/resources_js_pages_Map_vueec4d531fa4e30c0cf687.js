...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    addDivMarker: function addDivMarker(coords, color, popup) {
      var myCustomColour = color.slice(-2);
