...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("v-textarea", {
        staticClass: "description v-input--is-label-active v-input--is-dirty",
        attrs: { name: "description", label: "Описание", hint: "Hint text" },
        model: {
          value: _vm.text,
          callback: function($$v) {
            _vm.text = $$v
