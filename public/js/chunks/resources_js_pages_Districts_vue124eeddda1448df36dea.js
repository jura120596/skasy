    ...
    [
      ...
      _c(
        "router-link",
        {
          staticClass: "ml-4",
          attrs: {
            to: "/regions/" + _vm.$route.params.id + "/0?level=" + _vm.level
          }
        },
        [_vm._v("Добавить +")]
      ),
