...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "router-link",
        { attrs: { to: "region/" + _vm.$route.query.id + "/0" } },
        [_vm._v("Добавить +")]
      ),
      _vm._v(" "),
      _c(
