      ...
      if (newPhotos.length) {
        ...
        try {
          window.axios.post('/file/', formData).then(function (r) {
            _this2.files = _this2.files.concat([r.data.data]).slice(0, 10);
          });
        } catch (e) {
          console.log(e);
