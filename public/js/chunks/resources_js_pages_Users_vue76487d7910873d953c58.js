      ...
      _vm.$store.state.auth.user.role === 1024
        ? _c(
            "v-btn",
            {
              ...
              on: {
                click: function($event) {
                  return _vm.$router.push("/users/0")
                }
              }
            },
