  ...
  return _c(
    ...
    [
      ...
      _vm.user.id != _vm.$store.state.auth.user.id
        ...
        : _vm._e(),
      _vm._v(" "),
      _vm.user.district_id && _vm.user.village_id !== undefined
        ? _c("DistrictAutocomplete", {
            attrs: {
