...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("v-textarea", {
        attrs: { name: "description", label: "Описание", id: "textareadesc" },
        model: {
          value: _vm.text,
          callback: function($$v) {
            _vm.text = $$v
