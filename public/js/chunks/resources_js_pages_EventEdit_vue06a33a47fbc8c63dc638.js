...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    create: function create() {
      ...
      window.axios.post('/event', this.event).then(function (r) {// this.$router.push({name: "events"});
      })["catch"](function (e) {
