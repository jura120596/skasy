...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    level: function level() {
      if (this.level) return Number.parseInt(this.level);
      return 0;
    },
