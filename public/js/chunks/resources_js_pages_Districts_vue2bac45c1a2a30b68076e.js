    ...
    return {
      ...
      headers: {
        regions: [{
          value: 'name',
          text: vm.label,
          link: Number.parseInt(vm.$route.query.level) < 2,
          id: 'id'
        }]
      },
      filter: {
