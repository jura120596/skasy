  ...
  methods: {
    signUp: function signUp() {
      ...
      window.axios.post('/auth/signup', this.account).then(function (r) {
        ...
        _this.store.dispatch('auth/attempt', {
          token: r.data.data.access_token,
          ttl: r.data.data.expires_at,
          refreshTTL: false
        });
