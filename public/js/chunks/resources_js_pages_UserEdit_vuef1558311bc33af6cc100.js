...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(
        "\n    " + _vm._s(_vm.sd) + _vm._s(_vm.user.district_id) + "\n    "
      ),
      _c("DistrictAutocomplete", {
        attrs: {
