                            ...
                            "\n                        " +
                              _vm._s(
                                "Пользователь: " +
                                  ...
                                  _vm.$store.state.auth.user.id
                                    ? "Вы"
                                    : _vm.post.author.full_name)
                              ) +
                              "(\n                        "
                          ),
                          _c(
                            "a",
                            { attrs: { to: "/files/" + _vm.post.user_id } },
