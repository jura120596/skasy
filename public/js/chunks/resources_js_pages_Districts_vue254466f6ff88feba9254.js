    ...
    showItem: function showItem(id) {
      ...
      this.$router.push({
        ...
        query: {
          ...
          parent_district_id: this.$route.params.id
        }
      });
    }
  }
