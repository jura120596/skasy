...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    addDivMarker: function addDivMarker(coords, color, popup) {
      var myCustomColour = color.substr(0, 7);
      ...
      L.marker(coords, {
        icon: icon
      }).addTo(this.mymap).bindPopup(popup);
    },
      ...
      window.axios.get('/mapObject/', {
        ...
        _this2.places.filter(function (v) {
          ...
          _this2.addDivMarker({
            lat: p.lat,
            lng: p.lng
          }, p.color, p.name + '<br/>' + (p.points > 0 ? 'Требуются баллы: ' + p.points : ''));
        });
      })["catch"](function (e) {
        console.log(e);
      });
